...
public class ExtentReport2
{
    ...
    public void loginTest() throws IOException
    {
        ...
        ExtentHtmlReporter reporter=new ExtentHtmlReporter("learn_automation1.html");
        ...
        logger2.fail("Failed because of some issues", MediaEntityBuilder.createScreenCaptureFromPath("/Users/Talha/Desktop/logo.jpg").build());

        logger2.pass("Failed because of some issues", MediaEntityBuilder.createScreenCaptureFromPath("/Users/Talha/Desktop/logo.jpg").build());
