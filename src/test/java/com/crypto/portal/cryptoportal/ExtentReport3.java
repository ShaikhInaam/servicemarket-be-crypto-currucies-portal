...
public class ExtentReport3
{
    ...
    public void setup()
    {
        ExtentHtmlReporter reporter=new ExtentHtmlReporter("learn_automation2.html");
        ...
        logger =extent.createTest("newTest");
    }
    ...
    {
        System.setProperty("webdriver.chrome.driver", "C:/Users/Talha/Downloads/chromedriver_win32/chromedriver.exe");
